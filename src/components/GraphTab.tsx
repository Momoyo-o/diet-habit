...
export default function GraphTab({ data, dateKey }: Props) {
  ...
  // Streak: count consecutive days with any record up to today
    ...
    <div className="space-y-4">
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            { label: '開始体重', val: startWeight, unit: 'kg' },
            { label: '現在体重', val: currentWeight ?? '—', unit: currentWeight ? 'kg' : '' },
